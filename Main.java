...
Problem Statement:  
Design and implement Factory design pattern for the given context. 
Consider Car building process, which requires many steps from allocating accessories to final makeup.
These steps should be written as methods and should be called while creating an instance of a specific
 car type. Hatchback, Sedan, SUV could be the subclasses of Car class. Car class and its subclasses, 
...
abstract class Car1_27051{//Class for car

	public Car1_27051(CarType model) {
		this.model = model;
	}
...
class LuxuryCar extends Car1_27051{//Luxury car class
...
class SmallCar extends Car1_27051 {//Small car class
...
class SedanCar extends Car1_27051 {//Sedan car class
...
class SuvCar extends Car1_27051 {//Suv car class
...
class CarFactory {//Car factory class
	...
	public static Car1_27051 buildCar(CarType model) {
		Car1_27051 car = null;
		switch (model) {
		case SMALL:
			//Show small cars
